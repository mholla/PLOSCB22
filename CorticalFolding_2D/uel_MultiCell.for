...
c      write(*,*),'F_tau = ',F_tau
      ...
      delta_v1      = props(39) ! final destination for cells 
      delta_v2      = props(40)
      delta_v3      = props(41)
...
c      coordiff3 = -(radius - 0.93*239.5) ! update 
       coordiff = -(radius -  0.85*239.0)
       coordiff2 = -(radius - 0.90*239.0) ! update 
       coordiff3 = -(radius - 1.0*239.0) ! update 
      ! 3-D ball
...
c      coordiff3 = -(xcoord - 0.2)
      ! 2-D 
      coordiff = -(radius - 0.2*239.0)   
      coordiff2 = -(radius - 0.2*239.0)    
      coordiff3 = -(radius - 0.2*239.0)    
      ! 3-D
