...
ub = [0.0000315,   3375,    67500.0,    450000.0,   192.0,     211.0    223.0]; 
lb = [0.000007,    750,     15000.0,    100000.0,   191.0,     210.0    222.0];
...
ftns = @(p) objfunc(E31E39Length_micro,E31E39Density1d_micro,...
                    ...
                    p(4),k_c_normal,k_c_para,alpha_normal,alpha_para,...
...
[NT11_1,NT11_2,NT11_3,...
 ...
 disp_1,disp_2,disp_3] = FEM_constitutive(alpha,alpha2,alpha3,...
                ...
                B(4),k_c_normal,k_c_para,alpha_normal,alpha_para,...
                lam_c,lam_s,mu_c,mu_s,... 
