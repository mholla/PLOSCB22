...
c      coordiff2 = -(xcoord - 0.8) ! update 
c      coordiff3 = -(xcoord - 0.9) ! update 
      ! 2-D
c      coordiff = -(radius -  0.8*239.0)
c      coordiff2 = -(radius - 0.88*239.5) ! update 
c      coordiff3 = -(radius - 0.93*239.5) ! update 
c      coordiff = -(radius -  0.85*239.0)
c      coordiff2 = -(radius - 0.90*239.0) ! update 
c      coordiff3 = -(radius - 1.0*239.0) ! update 
      ! 3-D ball
      coordiff  = -(radius_3d - 0.85*239.0)
      coordiff2 = -(radius_3d - 0.90*239.0)
      coordiff3 = -(radius_3d - 1.0*239.0)
...
c      coordiff = (xcoord - 0.98)
      ! 2-D 
c      coordiff = (radius - 0.93*239.0)
      ! 3-D
      coordiff = (radius_3d - 0.90*239.0)
...
c      coordiff2 = -(xcoord - 0.2)
c      coordiff3 = -(xcoord - 0.2)
      ! 2-D 
c      coordiff = -(radius - 0.2*239.0)   
c      coordiff2 = -(radius - 0.2*239.0)    
c      coordiff3 = -(radius - 0.2*239.0)    
      ! 3-D
      coordiff  = -(radius_3d - 0.2*239.0) 
      coordiff2 = -(radius_3d - 0.2*239.0) 
      coordiff3 = -(radius_3d - 0.2*239.0) 
...
c      Diffusivity = diff*(1.5 - 0.95*Hhatd)
      ...
      Gc_time1 = (epsilon1**2.0)/((TIME - 0.0)**2.0 + epsilon1**2.0)
