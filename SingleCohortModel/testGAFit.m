...
%final destinations for three cohorts of cells
delta_v1 = 195.0;
delta_v2 = 100.0;
delta_v3 = 100.0;  
...
density_total_time1 = E31E39Density1d_micro...
                    + E33E40Density1d_micro; 
length_time1 = E31E39Length_micro;  

density_total_time2 = E31P6Density1d_micro...
                    + E33P6Density1d_micro...
                    + E36P5Density1d_micro; 
length_time2 = E31P6Length_micro;

density_total_time3 = E31P16Density1d_micro...
                    + E34P16Density1d_micro...
                    + E37P16Density1d_micro; 
length_time3 = E31P16Length_micro;

h1 = plot(length_time1,density_total_time1,'ko');
hold on
h2 = plot(length_time2,density_total_time2,'bo');
hold on
h3 = plot(length_time3,density_total_time3,'ro');
hold on 
xlim([0,2500])
ylim([0,15e-5])
legend([h1 h2 h3],'time1','time2','time3',...
                  'location','best')
legend('boxoff')
...
%        %Gc,      vel,      diff,        k_s      delta_v1 
ub = [0.00004,   1600,     35000.0,    350000.0,   230.0]; 
lb = [0.00002,   1400,     25000.0,    150000.0,   190.0];
% here I start the GA calibration 
% this is the fitness function 

ftns = @(p) objfunc(length_time1,density_total_time1,...
                    length_time2,density_total_time2,...
                    length_time3,density_total_time3,...
                    alpha,alpha2,alpha3,alpha_Gc,alpha_Gc2,alpha_Gc3,...
                    alpha_v,alpha_v2,alpha_v3,alpha_d,alpha_d2,alpha_d3,...
                    alpha_mu,alpha_k,p(1),Gc2,Gc3,p(2),p(2),p(2),...
                    p(3),p(3),p(3),c0,c02,c03,...
                    p(4),p(4),p(4),alpha_normal,alpha_para,...
                    lam_c,lam_s,mu_c,mu_s,... 
                    epsilon1,epsilon2,epsilon3,p(5),delta_v2,delta_v3,...
                    nlSdv,ngSdv,nInt); 
...
[NT11_1,NT11_2,NT11_3,...
 ...
 disp_1,disp_2,disp_3] = FEM_constitutive(alpha,alpha2,alpha3,...
                ...
                alpha_v,alpha_v2,alpha_v3,alpha_d,alpha_d2,alpha_d3,...
                alpha_mu,alpha_k,B(1),Gc2,Gc3,B(2),B(2),B(2),...
                B(3),B(3),B(3),c0,c02,c03,...
                B(4),B(4),B(4),alpha_normal,alpha_para,...
                lam_c,lam_s,mu_c,mu_s,... 
                epsilon1,epsilon2,epsilon3,B(5),delta_v2,delta_v3,...
                nlSdv,ngSdv,nInt);              
...
plot(linspace(0,l0+disp_1,length(NT11_1)),NT11_1,'k-');
hold on 
plot(linspace(0,l0+disp_2,length(NT11_2)),NT11_2,'b-');
hold on 
plot(linspace(0,l0+disp_3,length(NT11_3)),NT11_3,'r-');
hold on
...
function [err] = objfunc(length_time1,density_total_time1,...
                         length_time2,density_total_time2,...
                         length_time3,density_total_time3,...
                    alpha,alpha2,alpha3,alpha_Gc,alpha_Gc2,alpha_Gc3,...
                    alpha_v,alpha_v2,alpha_v3,alpha_d,alpha_d2,alpha_d3,...
          ...
          disp_1,disp_2,disp_3] = FEM_constitutive(alpha,alpha2,alpha3,...
             ...
             err_c_t1 = norm(NT11_1 - density_total_time1)/norm(density_total_time1);
             err_c_t2 = norm(NT11_2 - density_total_time2)/norm(density_total_time2);
             err_c_t3 = norm(NT11_3 - density_total_time3)/norm(density_total_time3);
             ...
             err_disp_t1 = norm(l_E31_sim + disp_1 - l_E39_exp)/norm(l_E39_exp);
             err_disp_t2 = norm(l_E31_sim + disp_2 - l_P6_exp)/norm(l_P6_exp); 
             err_disp_t3 = norm(l_E31_sim + disp_3 - l_P16_exp)/norm(l_P16_exp);
             ...
             weight_dis = 1/6;
              ...
              % total error 
              err = weight_c*(err_c_t1 + err_c_t2 + err_c_t3)...
                  + weight_dis*(err_disp_t1 + err_disp_t2+ err_disp_t3);              
